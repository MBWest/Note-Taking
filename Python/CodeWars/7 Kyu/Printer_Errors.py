...
# that the printer used three times color a, four times color b, one time
...
# will return the error rate of the printer as a string representing a 
# rational whose numerator is the number of errors and the denominator the 
